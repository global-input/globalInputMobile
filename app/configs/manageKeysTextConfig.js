const manageKeysTextConfig = {
  ...
  content: [
    'Press the "+" button at the bottom right corner of your screen to create a new encryption key.',
  ],
  encryptionDetails: {
    activated: {
  ...
  export: {
    fillContent: {
      ...
      password: {
        ...
        content2: [
          '3. Press the "Encrypt" button to encrypt the encryption key using the password you have provided. The encrypted content will be sent over to the connected application.',
        ],
      },
    },
    qrcode: {
      password: {
        ...
        placeHolder: 'Password',
        content1: [
          'Exporting the encryption key as password protected QR Code:',
          '1. Provide the password in the following field for encrypting the encryption key:',
        ],
        content2: [
          '2. Press the "Encrypt" button to create the password protected QR Code for this encryption key.',
        ],
      },
      title: 'Encrypted QR Code',
      content: ['Scan with your Global Input App:'],
      content2: [
        'This is the password protected QR Code for the encryption key "{name}". You can print it out and put it in a safe place in case you lose your phone.',
    ...
    textContent: {
      password: {
        ...
        placeHolder: 'Password',
        content1: [
          'Exporting the encryption key as password protected text content:',
          '1. Password for encrypting the encryption key:',
        ],
        content2: [
          '2. Press the "Encrypt" button to create the password protected content for this encryption key.',
        ],
      },
      clipboard: {
        ...
        content2: [
          'Please press the "Copy" button to copy the content into your clipboard.',
        ],
      },
      complete: {
        title: 'Export Completed',
        content: [
          'The encrypted encryption key "{name}" is now exported to your clipboard.',
  ...
  importKey: {
    ...
    content: [
      'The QR Code is identified as an encryption key, and it is protected with a password.',
      '1. You need to provide the password to decrypt it:',
    ],
    password: {
  ...
  deletingEncryptionKey: {
    ...
    content2: [
      'If you have some exported data that was encrypted with the encryption key that you are deleting, you will not be able to import the exported data unless you have exported/shared the encryption key.',
  ...
  generateNewKey: {
    ...
    content: [
      'Press the "Import" button to import this encryption key into the app',
    ],
  },
  errorMessages: {
  ...
  encryptionActivated: {
    ...
    content: [
      'The encryption key is now activated.',
