var eyeTextConfig = {
  ...
  pairing: {
    sameData: {
      ...
      message:
        'Your app already contains the same settings that are provided by the QR Code',
      button: 'OK',
    },
    confirm: {
      title: 'Modifying Settings',
      message:
        'Do you want to accept and overwrite your current settings with that provided by the QR Code?',
      confirm: 'Accept',
      cancel: 'Cancel',
    },
    complete: {
