var manageFormDataTextConfig = {
  ...
  noData: {
    content: [
      ...
      {
        type: 'text',
        content: 'https://globalinput.co.uk/',
  ...
  errorMessages: {
    formId: {
      tooShort:
        'The ID value is too short. You can enter content like username@mycompany.com to uniquely identify your data item.',
      alreadyExists:
        'The ID already exists. You may use the pattern "username@mycompany.com".',
      alreadyExistsForNewFormId:
        'The value of the ID field is already taken by another data item in the app.',
      tooLong:
        'The ID value is too long, you may enter content like username@mycompany.com to uniquely identify your data item.',
    },
    formFields: {
      noneExist:
        "At least one field is required. Press the 'Add Field' button to add a new field.",
    },
    decryptError: {
    ...
    newField: {
      newFieldMissing:
        'Please provide the name of the new field you would like to add',
  ...
  addAField: {
    ...
    content2: [
      '2. Check the checkbox below if the field you are adding is a multi-line field:',
    ],
  ...
  qrcode: {
    ...
    content2: [
      'The QR Code is valid for this session only. It contains the encryption key for end-to-end encryption, the URL of the WebSocket server, and the API key required for connecting to the WebSocket Server.',
    ],
  },
  newForm: {
    title: 'New Data',
