const encryptedQrCodeTextConfig = {
  ...
  content: [
    'Press the "+" button at the bottom right corner of your screen to create an encrypted QR Code.',
  ],
  enterContent: {
  ...
  fillContent: {
    ...
    content: [
      '3. Press the "Encrypt" button to encrypt the content with the selected encryption key. The encrypted content will be sent over to the connected application.',
    ],
  },
  qrcode: {
    content: ['Scan with your Global Input App'],
    content2: [
      'This is an encrypted QR Code. Other Global Input App installations will not be able to decrypt the QR Code unless you have shared the encryption key.',
