...
export default class DeviceDetector{
  ...
  matchScreenSize(w, h){
    return (this.device.height === h && this.device.width ===w)||(this.device.height === w && this.device.width === h);
  }
  ...
  getDevice(){      
      ...
      if(this.matchScreenSize(375,812) || this.matchScreenSize(414,896) || this.matchScreenSize(390,844)){
