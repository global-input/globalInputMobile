...
export default ({onContentEncrypted,menuItems,title,help})=>{
          ...
          try{
                    ...
                    if(!content){
                        setErrorMessage(encryptedQrCodeTextConfig.errorMessages.contentIsMissing);
                          ...
                          var encryptedContent=appdata.encryptWithAnEncryptionKey(content,action.selectedEncryptionKeyItem);
  ...
  return(
    ...
    menuItems={menus} selected={menusConfig.encryptedQrCode.menu}>
